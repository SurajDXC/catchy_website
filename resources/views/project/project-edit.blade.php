					        ...
					        <div class="row">
                                 ...
                                 <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <img class="img-fluid pb-4" width="100" height="100" src="{{$project->image_featured2 ?  $project->image_featured2 : '/img/200x200.png'}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="excerpt" class="form-control" id="excerpt" rows="10">{{clean( $project->excerpt , array('Attr.EnableID' => true))}}</textarea>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 1</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal1 ? $project->img_gal1 : '/img/200x200.png'}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 2</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal2 ? $project->img_gal2 : '/img/200x200.png'}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 3</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal3 ? $project->img_gal3 : '/img/200x200.png'}}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.photo') , array('Attr.EnableID' => true))}} 4</strong>
                                                 <img class="img-fluid pb-4" width="100" height="100" src="{{$project->img_gal4 ? $project->img_gal4 : '/img/200x200.png'}}">
